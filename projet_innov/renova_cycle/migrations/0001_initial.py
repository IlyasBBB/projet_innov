    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('waste_type', models.CharField(choices=[('ORGANIC', 'Organique'), ('NON_ORGANIC', 'Non Organique')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('CITIZEN', 'Citoyen'), ('MUNICIPALITY', 'Municipalité'), ('WASTE_PICKER', 'Chiffonier'), ('SUPERVISOR', 'Superviseur')], max_length=20)),
                ('phone_number', models.CharField(max_length=20)),
                ('identity_card', models.CharField(blank=True, max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('container', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='renova_cycle.wastecontainer')),
            ],
        ),
        migrations.CreateModel(
            name='WasteDeposit',
